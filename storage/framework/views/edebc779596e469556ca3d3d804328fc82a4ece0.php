                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    <?php $__currentLoopData = $demande->events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="accordion  accordion-toggle-arrow" id="accordionExample4">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseSix4" class="collapse" aria-labelledby="headingThree1"
                                         data-parent="#accordionExample4">
                                        <div class="card-body">
                                        <?php echo e($demande->demandeur->nom); ?>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseThree4" class="collapse" aria-labelledby="headingThree1"
                                         data-parent="#accordionExample4">
                                        <div class="card-body">
                                            <?php echo e($demande->categorie->label); ?>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseFour4" class="collapse" aria-labelledby="headingThree1"
                                         data-parent="#accordionExample4">
                                        <div class="card-body">
                                            <?php echo e($demande->adresse); ?><br/>
                                            <?php echo e($demande->cp); ?><br/>
                                            <?php echo e(isset($demande->ville) ? $demande->ville->name : ''); ?>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseFive4" class="collapse" aria-labelledby="headingThree1"
                                         data-parent="#accordionExample4">
                                        <div class="card-body">
                                            <?php echo e($demande->demandeur->telephone); ?>
...
<?php /**PATH /home/rdvavecvbk/clients/resources/views/partials/details.blade.php ENDPATH**/ ?>