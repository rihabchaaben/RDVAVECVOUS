        ...
        <div class="kt-subheader-search ">
            <div class="kt-container  kt-container--fluid ">
                <h3 class="kt-subheader-search__title">
                    ...
                    <span class="kt-subheader-search__desc">Liste des Propositions effectué dans notre platfort</span>
                </h3>
                <form class="kt-form">
                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            Liste des propositions
                            <small>Liste des propositions inscris dans notre platform</small>
                        </h3>
                    </div>
                    ...
                    <div class="kt-section">
                        <div class="kt-section__content">
                            <table class="table table-striped" id="testTable'">
                               ...
                               <?php if(isset($proposition->demande) && isset($proposition->professionnel)): ?> 
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo e($proposition->demande->nom); ?></td>
                                        ...
                                        <td><?php echo e($proposition->professionnel->cp); ?>

                                        </td>
                                        <td><?php echo e($proposition->professionnel->ville->name); ?>

                                        </td>
                                         
                                        <?php if($proposition->devis===4 || $proposition->devis===2): ?>
                                        <th scope="row">Devis envoye</th>
                                        <?php else: ?>  
                                        <th scope="row">Devis Non envoye</th>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/admin/propositions/index.blade.php ENDPATH**/ ?>