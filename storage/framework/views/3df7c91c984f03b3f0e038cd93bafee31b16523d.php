                        ...
                        <div class="kt-login__body">
                            <div class="kt-login__logo">
                                <a href="<?php echo e(route('login')); ?>">
                                    <img src="<?php echo e(asset('images/logo_typo.png')); ?>">
                                </a>
                            </div>
                                ...
                                <div class="kt-login__form">
                                    <form class="kt-form" method="post" action="<?php echo e(route('password.email')); ?>">
                                        ...
                                        <div class="kt-login__actions">
                                            <button id="kt_login" type="submit"
...
<?php /**PATH /home/rdvavecvbk/clients/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>