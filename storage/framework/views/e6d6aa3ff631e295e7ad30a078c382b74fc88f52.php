...
@media (max-width : 720px) {
    .visibledesktop {display:none;}
                ...
                <div class="visibledesktop"> <img alt="Logo" src="<?php echo e(asset('images/logo_typo.png')); ?>" width="290px" height="60px"/></div>
...
<!--                     <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                   ...
                   <span class="kt-header__topbar-icon kt-header__topbar-icon--success" >
                      ...
                      <a href="<?php echo e(url('chat')); ?>"> <i class="flaticon2-bell-alarm-symbol" style="font-size: 2.1rem;color:#2D328C"></i> </a>
                 
                </span> 


                <?php if(\App\Message::where('to_id', Auth::user()->id)
        ->where('readed_at','=',NULL)
            ->count()>0): ?>
                
                <span class="kt-badge kt-badge--danger kt-font-bold"> 
                  
                <?php echo e(\App\Message::where('to_id', Auth::user()->id)
        ->where('readed_at','=',NULL)
            ->count()); ?>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                            <div class="kt-header__topbar-user">
                                ...
                                <span class="kt-hidden kt-header__topbar-username kt-hidden-mobile"><?php echo e(ucfirst(Auth::user()->name[0])); ?></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                            ...
                            <div class="kt-notification">
                                <a href="<?php echo e(route('pro.profile')); ?>" class="kt-notification__item">
                                ...
                                <a href="<?php echo e(route('pro.chat')); ?>" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                ...
                                <a href="<?php echo e(route('pro.profile','tarif')); ?>" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                        <i class="flaticon2-calendar-3 kt-font-success"></i>
                                    </div>
                                    <div class="kt-notification__item-details">
                                ...
                                <a href="<?php echo e(route('pro.mes_kbis_create')); ?>" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                ...
                                <a href="<?php echo e(route('faq')); ?>" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                ...
                                <a href="<?php echo e(route('pro.contactUs_create')); ?>" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
...
<!-- end::Scrolltop<?php /**PATH /home/rdvavecvbk/clients/resources/views/layouts/front/professionnel/header.blade.php ENDPATH**/ ?>