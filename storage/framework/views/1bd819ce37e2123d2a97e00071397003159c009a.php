...
<div class="kt-grid kt-grid--ver kt-grid--root">
                        ...
                        <div class="kt-login__body">
                            <div class="kt-login__logo">
                                <a href="<?php echo e(route('login')); ?>">
                                    ...
                                    <img src="<?php echo e(asset('images/logo_login_background.png')); ?>">
                                </a>
                            </div>
                            <div class="kt-login__signup" style="display:block">
                                ...
                                <div class="kt-login__form">
                                    <form method="post" action="<?php echo e(route('register')); ?>" class="kt-form"
                                          id="kt_form">
                                        <?php echo csrf_field(); ?>
                                        <div class="input-group">
                                            <input class="form-control" type="text" placeholder="IDENTIFIANT"
                                            
                                            name="name" value="<?php echo e(old('name')); ?>" style="font-size: 18px">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            autocomplete="off" value="<?php echo e(old('email')); ?>" style="font-size: 18px">
                                        </div>
                                        ...
                                        <strong style="color: red;"><?php echo e($errors->first('role')); ?></strong>
                                        ...
                                        <strong style="color: red;"><?php echo e($errors->first('agree')); ?></strong>
                                        <br><br>
 <?php echo Recaptcha::render(); ?>
                   ...
                   Vous avez un compte ?
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="kt-login__account-link" style="font-size: 18px; color:#3758FF"> SE CONNECTER </a>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/rdvavecvbk/clients/resources/views/auth/register.blade.php ENDPATH**/ ?>