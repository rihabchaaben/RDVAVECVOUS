    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-grid--stretch">
        <div class="kt-container kt-body  kt-grid kt-grid--hor space--top" id="kt_body">
            ...
            <span class="kt-subheader__desc" id="kt_subheader_total" style="color:black">
                              <?php echo e($citation->type); ?> - <?php echo e($citation->annee); ?>
                                    ...
                                    <div class="kt-widget17__stats">
                                        <div class="kt-widget17__items">
                                            <div class="kt-widget17__item">
                                                ...
                                                <span class="kt-widget17__desc">
																<?php echo e($rdvAccepte); ?> rdv accepte
															</span>
                                            </div>
                                            <div class="kt-widget17__item">
															<span class="kt-widget17__icon">
                                        ...
                                        <div class="kt-widget17__items">
                                            <div class="kt-widget17__item">
                                                ...
                                                <span class="kt-widget17__desc">
																<?php echo e($rdvNoProp); ?> rdv sans prop
															</span>
                                            </div>
                                            <div class="kt-widget17__item">
															<span class="kt-widget17__icon">
                                                ...
                                                <div class="kt-timeline-v2__item">
                                                    ...
                                                    <div class="kt-timeline-v2__item-text kt-timeline-v2__item-text--bold"
                                                        ...
                                                        Votre prochain rdv avec<a data-toggle="modal"
                                                                                   data-target="#kt_modal_9<?php echo e($key); ?>"
                                                                                   class="kt-link kt-link--brand kt-font-bolder">
                                                            &nbsp;<?php echo e($timeline->professionnel->nom); ?></a>

                                                    </div>
                                                    <div class="kt-list-pics kt-list-pics--sm kt-padding-l-20"
                                                         style="cursor:pointer">
                                                        <?php if($timeline->professionnel->avatar): ?>
                                                            <a data-toggle="modal" data-target="#kt_modal_9<?php echo e($key); ?>">
                                                                <img src="<?php echo e(asset('storage/'.$timeline->professionnel->avatar)); ?>" title=""></a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <?php echo $__env->make('demandeur.demandes.details_pro',['proposition'=>$timeline,'key'=>$key], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                             <?php endif; ?>
                                ...
                                <div class="kt-portlet__head-toolbar">
                                    <div class="kt-portlet__head-wrapper">
                                        <div class="kt-portlet__head-actions">
                                            &nbsp;
                                            <a href="<?php echo e(route('demandeur.mes_demandes_create')); ?>"
...
<?php $__env->startSection('script'); ?>
    <?php $__currentLoopData = $demandeurVip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <?php echo $__env->make('demandeur.last_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.demandeurs.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/demandeur/dashboard.blade.php ENDPATH**/ ?>