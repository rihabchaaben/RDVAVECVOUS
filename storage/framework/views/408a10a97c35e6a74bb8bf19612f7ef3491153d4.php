                            ...
                            <div class="kt-portlet kt-portlet--head-lg kt-portlet--last">
                                ...
                                <form action="<?php echo e(route('pro.chat.store','#last_chat')); ?>" method="post">
                                    ...
                                    <input type="hidden" name="proposition_id"
                                           value="<?php echo e($messages->first()->proposition_id); ?>"> <input type="hidden"
                                                                                                  name="from_id"
                                                                                                  value="<?php echo e($messages->first()->userTo->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.professionnel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/professionnel/chats/index.blade.php ENDPATH**/ ?>