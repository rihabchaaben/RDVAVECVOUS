...
<head>
    ...
    <link href="<?php echo e(asset('/assets/demo/demo6/base/style.bundle.css')); ?>" rel="stylesheet" type="text/css"/>
...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="index.html">
            <img alt="Logo" src="<?php echo e(asset('/assets/media/logos/logo-6-sm.png')); ?>"/>
        </a>
    </div>
...
<script src="<?php echo e(asset('/assets/vendors/general/ion-rangeslider/js/ion.rangeSlider.js')); ?>"
        type="text/javascript"></script>
...
<script src="<?php echo e(asset('/assets/vendors/custom/components/vendors/sweetalert2/init.js')); ?>"
        type="text/javascript"></script>
...
<script src="<?php echo e(asset('/assets/demo/demo6/base/scripts.bundle.js')); ?>" type="text/javascript"></script>
...
<!-- end::Body -->
</html><?php /**PATH /home/rdvavecvbk/clients/resources/views/layouts/admin/master.blade.php ENDPATH**/ ?>