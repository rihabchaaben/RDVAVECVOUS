    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
            ...
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="<?php echo e(route('admin.index')); ?>"
                                                                                         class="kt-menu__link "><i
                                class="kt-menu__link-icon flaticon2-protection"></i><span
                                class="kt-menu__link-text">Dashboard</span></a></li>
                <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo e(route('admin.demandeurs')); ?>"
                                                                   class="kt-menu__link "><i
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                    ...
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo e(route('admin.devis')); ?>"
                                                                               class="kt-menu__link "><i
                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                            class="kt-menu__link-text">Devis</span></a></li>
                            <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo e(route('admin.factures')); ?>"
                                                                               class="kt-menu__link "><i
                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                ...
                <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo e(route('admin.professionnels')); ?>"
                                                                   class="kt-menu__link "><i
                                class="kt-menu__link-icon flaticon2-medical-records-1"></i><span
                                class="kt-menu__link-text">Professionnels</span></a></li>
                <li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo e(route('admin.vendeurs')); ?>"
                                                                   class="kt-menu__link "><i
                                class="kt-menu__link-icon flaticon2-hourglass-1"></i><span
...
<!-- end:: Aside --><?php /**PATH /home/rdvavecvbk/clients/resources/views/layouts/admin/sidebar.blade.php ENDPATH**/ ?>