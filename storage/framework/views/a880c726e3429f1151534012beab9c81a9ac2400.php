                                ...
                                <div class="kt-widget17__items">
                                    <div class="kt-widget17__item" style="cursor:default">
                                        ...
                                        <span class="kt-widget17__desc">
																<?php echo e($newprop); ?> nouvelle proposition(s)
															</span>
                                    </div>
                                    <div class="kt-widget17__item" style="cursor:default">
															<span class="kt-widget17__icon">
                                        ...
                                        <span class="kt-widget17__desc">
																<?php echo e($rdvAttente); ?> rdv en attente
															</span>
                                    </div>
                                </div>
                                <div class="kt-widget17__items">
                                    <div class="kt-widget17__item" style="cursor:default">
                                        ...
                                        <span class="kt-widget17__desc">
																<?php echo e($rdvAccepte); ?> rdv validé(s)
															</span>
                                    </div>
                                    <div class="kt-widget17__item" style="cursor:default">
															<span class="kt-widget17__icon">
                                        ...
                                        <span class="kt-widget17__desc">
																<?php echo e($rdvRefuse); ?> rdv refusé(s)
															</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php $__currentLoopData = $timelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$timeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($timeline->demande->events->first()->start_date>= \Carbon\Carbon::today()): ?>
                                        <div class="kt-timeline-v2__item">
                                            <span class="kt-timeline-v2__item-time"
                                                  style="font-size: 13.3px;"><?php echo e($timeline->demande->events->first()->start_date->format('d/m/y')); ?></span>
                                            <div class="kt-timeline-v2__item-cricle">
                                                <i class="fa fa-genderless kt-font-success"></i>
                                            </div>
                                            <div class="kt-timeline-v2__item-text kt-timeline-v2__item-text--bold">
                                                Votre prochain rdv avec<a data-toggle="modal"
                                                                           data-target="#kt_modal_rdv_details<?php echo e($key); ?>"
                                                                           class="kt-link kt-link--brand kt-font-bolder"
                                                                           style="color:#1dc9b7;cursor: pointer">
                                                    &nbsp;<?php echo e($timeline->demande->demandeur->nom); ?></a>
                                        ...
                                        <?php echo $__env->make('partials.rdv_details',['proposition'=>$timeline,'key'=>$key], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                   <?php endif; ?>
...
<?php $__env->startSection('script'); ?>
    <?php if(request()->status == true): ?> <?php echo $__env->make('professionnel.last_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php endif; ?>
    <script>
        var map;
        function initMap() {
            ...
            var marker = new google.maps.Marker({
                    position: {lat: <?php echo e(isset($map->ville) ? $map->ville->latitude : 0); ?>, lng: <?php echo e(isset($map->ville) ? $map->ville->longitude : 0); ?>},
                    map: map,
                    title: '<?php echo e($map->nom); ?>',
            ...
            // });
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $mapsAccepted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $map): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    var marker = new google.maps.Marker({
                    position: {lat: <?php echo e(isset($map->ville) ? $map->ville->latitude : 0); ?>, lng: <?php echo e(isset($map->ville) ? $map->ville->longitude : 0); ?>},
                    map: map,
                    title: '<?php echo e($map->demande->nom); ?>',
                    // icon: 'pin.png',
                    animation: google.maps.Animation.BOUNCE,
                });
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.professionnel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/professionnel/dashboard.blade.php ENDPATH**/ ?>