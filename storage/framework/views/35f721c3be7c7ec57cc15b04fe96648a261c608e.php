                        ...
                        <div class="kt-portlet kt-portlet--last">
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <span class="kt-media kt-media--circle">
                                   ...
                                   <?php if($user->userFrom->professionnel->avatar): ?>

                                        <img src="<?php echo e(asset('storage/'.$user->userFrom->professionnel->avatar)); ?>"

                                             alt="image">

                                    <?php else: ?>

                                        <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bolder"><?php echo e(ucfirst($user->userFrom->professionnel->nom[0])); ?></span>
                                    ...
                                    <?php endif; ?>
                                                    ...
                                                    <div class="kt-widget__info">
                                                        ...
                                                        <div class="kt-widget__section">
                                                            ...
                                                            <a href="<?php echo e(route('demandeur.chat.show',[$user->proposition_id,'#last_chat'])); ?>"

                                                               class="kt-widget__username"><?php echo e($user->userFrom->professionnel->nom); ?></a>
                                        ...
                                        <?php echo e($user->userFrom->professionnel->categories->first()->label); ?>
                        ...
                        <div class="kt-chat">
                            ...
                            <div class="kt-portlet kt-portlet--head-lg kt-portlet--last">
                                ...
                                <div class="kt-portlet__head bg-blue">
                                            ...
                                            <div class="kt-chat__label">
                                                ...
                                                <a href="#"
                                                   ...
                                                   class="kt-chat__title">
                                                    ...
                                                    <?php echo e($messages->first()->userFrom->name); ?>
                                    ...
                                    <span class="kt-badge kt-badge--dot kt-badge--success"></span> <?php echo e($messages->first()->proposition->demande->events->first()->titre); ?>
                                    ...
                                    <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll"
                                        ...
                                        <div class="kt-chat__messages">
                                            ...
                                            <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($msg->userFrom->professionnel): ?>
                                       ...
                                       <?php if($msg->userFrom->professionnel->avatar): ?>
                                        ...
                                        <?php endif; ?>
                                                            ...
                                                            <a href="#"
                                                               ...
                                                               class="kt-chat__username"><?php echo e($msg->userFrom->professionnel->nom); ?></a>
                                        ...
                                        <?php if($msg->userFrom->demandeur->avatar): ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bolder"><?php echo e(ucfirst($msg->userFrom->demandeur->nom[0])); ?></span>
                                        ...
                                        <div class="ps__rail-y" style="top: 0px; height: 396px; right: -2px;">
                                            ...
                                            <div class="ps__thumb-y" tabindex="0"
                                                 ...
                                                 style="top: 0px; height: 161px;"></div>
                                ...
                                <form action="<?php echo e(route('demandeur.chat.store')); ?>" method="post">

                                    <?php echo csrf_field(); ?>

                                    <input type="hidden" name="proposition_id"

                                           value="<?php echo e($messages->first()->proposition_id); ?>">
...
<?php echo $__env->make('layouts.front.demandeurs.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/demandeur/chats/index.blade.php ENDPATH**/ ?>