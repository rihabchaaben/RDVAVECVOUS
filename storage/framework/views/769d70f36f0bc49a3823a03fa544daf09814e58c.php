...
<head>
    ...
    <link href="<?php echo e(asset('assets/vendors/general/bootstrap-datetime-picker/css/bootstrap-datetimepicker.css')); ?>"
          rel="stylesheet"
          type="text/css"/>
    <link href="<?php echo e(asset('assets/vendors/general/bootstrap-timepicker/css/bootstrap-timepicker.css')); ?>" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="<?php echo e(asset('assets/vendors/general/bootstrap-markdown/css/bootstrap-markdown.min.css')); ?>" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="<?php echo e(asset('assets/demo/demo3/base/style.bundle.css')); ?>" rel="stylesheet" type="text/css"/>
    ...
    <!-- loading page !-->
    <link href="<?php echo e(asset('css/modal-loading.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('css/modal-loading-animate.css')); ?>" rel="stylesheet" type="text/css"/>
...
<!-- begin:: Page -->
<?php echo $__env->make('layouts.front.demandeurs.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('assets/vendors/general/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(asset('assets/vendors/custom/components/vendors/bootstrap-datepicker/init.js')); ?>"
        type="text/javascript"></script>
...
<script src="<?php echo e(asset('assets/vendors/general/bootstrap-timepicker/js/bootstrap-timepicker.min.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(asset('assets/vendors/custom/components/vendors/bootstrap-timepicker/init.js')); ?>"
        type="text/javascript"></script>
...
<script src="<?php echo e(asset('assets/vendors/general/bootstrap-select/dist/js/bootstrap-select.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(asset('assets/vendors/general/bootstrap-switch/dist/js/bootstrap-switch.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(asset('assets/vendors/custom/components/vendors/bootstrap-switch/init.js')); ?>"
        type="text/javascript"></script>
...
<script src="<?php echo e(asset('assets/vendors/general/bootstrap-markdown/js/bootstrap-markdown.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(asset('assets/vendors/custom/components/vendors/bootstrap-markdown/init.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(asset('assets/vendors/general/bootstrap-notify/bootstrap-notify.min.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(asset('assets/vendors/custom/components/vendors/bootstrap-notify/init.js')); ?>"
        type="text/javascript"></script>
...
<script src="<?php echo e(asset('assets/vendors/general/jquery-validation/dist/additional-methods.js')); ?>"
        type="text/javascript"></script>
<script src="<?php echo e(asset('assets/vendors/custom/components/vendors/jquery-validation/init.js')); ?>"
        type="text/javascript"></script>
...
<script src="<?php echo e(asset('assets/demo/demo3/base/scripts.bundle.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('js/modal-loading.js')); ?>"
        type="text/javascript"></script>

<!--begin::Page Scripts(used by this page) -->
<script src="<?php echo e(asset('/assets/js/demo10/pages/crud/datatables/basic/basic.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('/assets/vendors/custom/datatables/datatables.bundle.js')); ?>"
        type="text/javascript"></script>
<!--end::Page Scripts -->
...
<?php /**PATH /home/rdvavecvbk/clients/resources/views/layouts/front/demandeurs/master.blade.php ENDPATH**/ ?>