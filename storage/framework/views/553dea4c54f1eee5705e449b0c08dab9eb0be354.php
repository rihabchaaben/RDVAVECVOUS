                        ...
                        <div class="kt-section__content">
                            <table class="table table-striped" id="testTable" >
                                ...
                                <?php $__currentLoopData = $devis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $devi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(isset($devi->professionnel)): ?>
                                   
                                    <tr>
                                        <th scope="row">1</th>
                                        <td><?php echo e($devi->id); ?></td>
                                        <td><a href="#"><?php echo e($devi->professionnel->nom); ?></a></td>
                                        <td><?php echo e($devi->designation); ?></td>
                                        <td><?php echo e($devi->montant); ?> $</td>
                                        <td><?php echo e($devi->quantite); ?></td>
                                        <td><?php echo e($devi->created_at); ?></td>
                                        <td><a href="#"><?php echo e($devi->demande_id); ?></a></td>
                                        <td>
                                            <div class="dropdown dropdown-inline">
                                                    ...
                                                    <ul class="kt-nav">
                                                        <li class="kt-nav__item">
                                                            <a href="#" class="kt-nav__link">
                                                                ...
                                                                <span class="kt-nav__link-text">Télécharger</span>
                                                            </a>
                                                        </li>
                                                        <li class="kt-nav__item">
                                                            <a href="<?php echo e(route('admin.devi_delete',$devi->id)); ?>"
                                                               class="kt-nav__link">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/admin/devis/index.blade.php ENDPATH**/ ?>