            ...
            <div class="kt-grid__item  kt-grid__item--order-tablet-and-mobile-2  kt-grid kt-grid--hor kt-login__aside">
                <div class="kt-login__wrapper">
                        ...
                        <div class="kt-login__body">
                            <div class="kt-login__logo">
                                <a href="#">
                                    ...
                                    <img src="<?php echo e(asset('images/logo_login_background.png')); ?>" width="80%" height="auto">
                                </a>
                            </div>
                            <div class="kt-login__signin">
                                ...
                                <div class="kt-login__form">
                                    <form method="post" action="<?php echo e(route('login')); ?>" class="kt-form">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row kt-login__extra">
                                            ...
                                            <div class="col kt-align-right">
                                                ...
                                                <a href="<?php echo e(route('password.request')); ?>" class="kt-login__link" style="font-size: 16px">Mot de passe oublié
                                                    ?</a>
                                            </div>
                                        </div>
                   ...
                   Vous n'avez pas encore de compte ?
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="kt-login__account-link" style="font-size: 18px; color:#3758FF"> CREER UN COMPTE </a>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\projetv4\resources\views/auth/login.blade.php ENDPATH**/ ?>