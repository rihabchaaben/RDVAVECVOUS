            ...
            <!-- end:: Content Head -->
                ...
                <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                    <div class="alert alert-outline-brand fade show" role="alert">
                        ...
                        <div class="alert-text" style="font-size: 16px">Vos coordonnées ne seront communiqués qu'aux professionnels que vous aurez sélectionnés.
                        </div>
                    ...
                    <div class="kt-portlet kt-portlet--tabs">
                        ...
                        <div class="kt-portlet__body">
                            <form action="<?php echo e(route('demandeur.profile_update',Auth::user()->demandeur->id)); ?>"
                                            ...
                                            <div class="kt-form__body">
                                                <div class="kt-section kt-section--first">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle-"
                                                                    ...
                                                                    <?php if(!$demandeur->avatar): ?>  <?php endif; ?>>
                                                                        <img src="<?php echo e(asset('storage/'.$demandeur->avatar)); ?>"
                                                                             id="blah" alt=""
                                                    ...
                                                    <i class="fa fa-times"></i>
                                                        ...
                                                        <?php if(!$demandeur->agence): ?>
                                                            <div class="form-group row" id="name">
                                                                <label class="col-xl-3 col-lg-3 col-form-label">
                                                                    Nom</label>
                                                                <div class="col-lg-9 col-xl-6">
                                                                    <input class="form-control" name="nom"
                                                                           value="<?php echo e($demandeur->nom); ?>">
                                                        ...
                                                        <?php else: ?>
                                                            <div class="section-hide">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <input class="form-control" name="nom_societe"
                                                                               <?php if($demandeur->agence): ?> value="<?php echo e($demandeur->agence->nom_societe); ?>" <?php endif; ?>>

                                                                               <?php if($errors->has('nom_societe')): ?>
                                                                <span class="" role="alert">
                                                                    <strong style="color: red;"><?php echo e($errors->first('nom_societe')); ?></strong>
                                                                </span>
                                                                <?php endif; ?>
                                                                    </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <input class="form-control" name="nom_contact"
                                                                               <?php if($demandeur->agence): ?> value="<?php echo e($demandeur->agence->nom_contact); ?>" <?php endif; ?>>

                                                                               <?php if($errors->has('nom_contact')): ?>
                                                                <span class="" role="alert">
                                                                    <strong style="color: red;"><?php echo e($errors->first('nom_contact')); ?></strong>
                                                                </span>
                                                                <?php endif; ?>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="phone"
                                                                           value="<?php echo e($demandeur->telephone); ?>"
                                                                           placeholder="Phone"
                                                        ...
                                                        <div class="form-group form-group-last row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Code
                                                                d'affiliation</label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control"
                                                                           value="<?php echo e($demandeur->ref); ?>"
                                                                           disabled="disabled">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-6">
                                                            <input class="form-control" type="text" name="adresse"
                                                                   value="<?php echo e($demandeur->adresse); ?>">
<?php if($errors->has('adresse')): ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-form-label col-lg-3">Ville</label>
                                                        <div class=" col-lg-6">
                                                            <select class="form-control" id="js-data-example-ajax"
                                                                    name="ville_id">
                                                                <?php if($demandeur->ville_id): ?>
                                                                    <option value="<?php echo e($demandeur->ville->id); ?>"><?php echo e($demandeur->ville->name); ?></option>
                                                                <?php endif; ?>
                                                            </select>
                                                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function () {
            $("#particulier_check").click(function () {
                $(".section-hide").hide();
                $("#name").fadeIn();
            });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.demandeurs.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/demandeur/profile_update.blade.php ENDPATH**/ ?>