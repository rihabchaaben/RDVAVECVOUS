            ...
            <div class="kt-portlet__head bg-blue">
                ...
                <div class="kt-portlet__head-toolbar">
                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand colors-item" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('pro.mes_devis_accepte')); ?>" role="tab"
                               aria-selected="false">
                                Accepté
                            ...
                            <?php else: ?>
                                <table class="table table-striped" id="kt_table_1">
                                    ...
                                    <?php $__currentLoopData = $propositions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($prop->demande->nom); ?></td>
                                            <td><?php echo e($prop->created_at); ?></td>
                                            <td><?php echo e($prop->demande->demandeur->nom); ?></td>
                                            <td><?php echo e($prop->demande->demandeur->telephone); ?></td>
                                            <td><?php echo e($prop->demande->ville->name); ?></td>
                                            <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <ul class="kt-nav">
                                                            <li class="kt-nav__item">
                                                                <a href="<?php echo e(route('pro.mes_devis_create',$prop->id)); ?>"
                                                                   class="kt-nav__link">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.professionnel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/professionnel/devis/devis.blade.php ENDPATH**/ ?>