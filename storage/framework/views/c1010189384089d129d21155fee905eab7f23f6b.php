                            ...
                            <table class="table table-striped"   id="testTable" summary="Code page support in different versions of MS Windows." rules="groups" frame="hsides">
                                ...
                                <?php $__currentLoopData = $pros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><a href="#"><?php echo e($pro->nom); ?></a></td>
                                        <td><?php echo e($pro->user->email); ?> </td>
                                        <td><?php echo e($pro->telephone); ?> </td>
                                        <td><?php echo e($pro->adresse); ?></td>
                                        <td>
                                     <?php if(!empty($pro->last->first())): ?>
                                    <?php echo e($pro->last->first()->created_at); ?>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                                    ...
                                                    <ul class="kt-nav">
                                                        <li class="kt-nav__item">
                                                            <a  href="<?php echo e(route('admin.factures.pro',$pro->id)); ?>" class="kt-nav__link">
                                                                <i class="kt-nav__link-icon flaticon2-line-chart"></i>
                                                                <span class="kt-nav__link-text">RDV valides et acceptes</span>
                                                            </a>
                                                        </li>
                                                        <li class="kt-nav__item">
                                                            <a href="<?php echo e(route('admin.payer.pro',$pro->id)); ?>" class="kt-nav__link">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/admin/factures/index.blade.php ENDPATH**/ ?>