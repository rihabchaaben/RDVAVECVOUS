                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                ...
                                &nbsp;
                                <a href="<?php echo e(route('admin.demandeur_create')); ?>"
                        ...
                        <div class="kt-section__content">
                            <table class="table table-striped" id="testTable" >
                                ...
                                <?php $__currentLoopData = $demandeurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demandeur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <?php if($demandeur->user): ?>
                                     <tr>
                                       
                                        <th scope="row"> <?php if($demandeur->user->email_verified_at): ?> VR <?php else: ?> NV <?php endif; ?></th>
                                        <td>RDV<?php echo e($demandeur->id); ?></td>
                                        <td><?php echo e($demandeur->nom); ?></td>
                                        
                                        <td><?php echo e($demandeur->user->email); ?></td>
                                        <td><?php echo e($demandeur->telephone); ?></td>
                                        <td><?php echo e($demandeur->adresse); ?></td>
                                        <td><?php echo e($demandeur->cp); ?></td>
                                        <td><?php echo e(\App\Proposition::demandeStatus('demandeur_id',$demandeur->id,[1,2,3])); ?></td>
                                        <td><?php echo e(\App\Proposition::demandeStatus('demandeur_id',$demandeur->id,[\App\Demande::ANNULE])); ?></td>
                                        <td>
                                            <div class="dropdown dropdown-inline">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                                    ...
                                                    <ul class="kt-nav">
                                                        ...
                                                        <li class="kt-nav__item">
                                                            <a href="<?php echo e(route('admin.demandeur_delete',$demandeur->id)); ?>" class="kt-nav__link">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rdvavecvbk/clients/resources/views/admin/demandeurs/index.blade.php ENDPATH**/ ?>