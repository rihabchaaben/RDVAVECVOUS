                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                ...
                                &nbsp;
                                <a href="{{route('admin.professionnel_create')}}"
                            ...
                            <table class="table table-striped"id="testTable"  >
                                ...
                                @foreach($professionnels as $professionnel)
                                    ...
                                    @endif
                                        ...
                                        <td>{{\App\Proposition::demandeStatus('professionnel_id',$professionnel->id,[1,2,3])}}</td>
                                        <td>{{\App\Proposition::demandeStatus('professionnel_id',$professionnel->id,[\App\Proposition::ACCEPTE])}}</td>
                                        <td>{{\App\Proposition::demandeStatus('professionnel_id',$professionnel->id,[\App\Proposition::REFUSE])}}</td>
                                        <td>{{\App\Avis::getAvis($professionnel->id)}}</td>
                                        <td>
                                            <div class="dropdown dropdown-inline">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                                    ...
                                                    <ul class="kt-nav">
                                                     ...
                                                     @if($professionnel->valide===0)
                                                      <li class="kt-nav__item">
                                                            <a href="{{url('admin/valide/'.$professionnel->id)}}"
                                                               class="kt-nav__link">
                                                    ...
                                                    <li class="kt-nav__item">
                                                            <a href="{{route('admin.professionnel_show',$professionnel->id)}}"
                                                               class="kt-nav__link">
                                                        ...
                                                        <li class="kt-nav__item">
                                                            <a href="{{route('admin.professionnel_delete',$professionnel->id)}}"
                                                               class="kt-nav__link">
