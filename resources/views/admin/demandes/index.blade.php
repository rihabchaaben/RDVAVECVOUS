                        ...
                        <div class="kt-section__content">
                            <table class="table table-striped"  id="testTable">
                                ...
                                @foreach($demandes as $key=>$demande)
                                   @if(isset($demande->demandeur) && isset($demande->demandeur->user)) 
                                    ...
                                    <tr>
                                         ...
                                         @if($demande->getDemandeStatus($demande->id)==1)
                                        <th scope="row">EN A</th>

                                        @elseif($demande->getDemandeStatus($demande->id)==2)
                                        <th scope="row">ACC</th>
                                        @elseif($demande->getDemandeStatus($demande->id)==3)
                                        <th scope="row">NEW</th>
                                        @elseif($demande->getDemandeStatus($demande->id)==4)
                                        <th scope="row">R  </th>
                                        ...
                                        <td>{{$demande->nom}}</td>
                                         @if($demande->events->count()>0)
                                         <td>{{$demande->events->first()->start_date->format('Y.m.d')}}</td>
                                         @else <td> <span class="badge badge-danger">ici le probleme</span> </td>
                                          @endif
                                        <td>{{$demande->categorie->label}}</td>
                                        <td>{{$demande->demandeur->nom}}</td>
                                        <td>{{$demande->demandeur->user->email}}</td>
                                        <td>{{$demande->demandeur->telephone}}</td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                                    ...
                                                    <ul class="kt-nav">
                                                        <li class="kt-nav__item">
                                                            <a href="{{route('admin.demandes.prpositions',$demande->id)}}" class="kt-nav__link">
                                                        ...
                                                        <li class="kt-nav__item">
                                                            <a data-toggle="modal" data-target="#kt_modal_rdv_details{{$key}}" class="kt-nav__link">
                                    ...
                                    @include('partials.details',['demande'=>$demande,'key'=>$key])
