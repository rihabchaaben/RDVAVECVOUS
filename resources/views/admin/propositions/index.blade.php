                    ...
                    <div class="kt-section">
                        <div class="kt-section__content">
                            <table class="table table-striped" id="testTable'">
                               ...
                               @if(isset($proposition->demande) && isset($proposition->professionnel)) 
                                    ...
                                    <tr>
                                       ...
                                       <td>{{$proposition->demande->nom}}</td>
                                        ...
                                        <td>{{$proposition->professionnel->cp}}
                                        </td>
                                        <td>{{$proposition->professionnel->ville->name}}
                                        </td>
                                         
                                        @if($proposition->devis===4 || $proposition->devis===2)
