...
<head>
    <meta charset="utf-8"/>
    <title>RDVavecVous | Login Page v6</title>
            ...
            <div class="kt-grid__item  kt-grid__item--order-tablet-and-mobile-2  kt-grid kt-grid--hor kt-login__aside">
                <div class="kt-login__wrapper">
                        ...
                        <div class="kt-login__body">
                            <div class="kt-login__logo">
                                <a href="#">
                                    ...
                                    <img src="{{asset('images/logo_login_background.png')}}" width="80%" height="auto">
                                </a>
                            </div>
                            <div class="kt-login__signin">
                                <div class="kt-login__head">
                                    {{-- <h3 class="kt-login__title">Connexion</h3> --}}
                                    {{-- <h1 class="kt-login__title" style="font-size: 28px" >Connexion</h1> --}}
                                </div>
                                        ...
                                        <div class="row kt-login__extra">
                                            <div class="col">
                                                <label class="kt-checkbox">
                                                    ...
                                                    <input type="checkbox" name="remember" style="font-size: 18px"> Se rappeler de moi
                                                    <span></span>
                                                </label>
                                            </div>
                                            <div class="col kt-align-right">
                                                {{-- <a href="{{route('password.request')}}" class="kt-login__link">Mot de passe oublié --}}
                                                <a href="{{route('password.request')}}" class="kt-login__link" style="font-size: 16px">Mot de passe oublié
                                                    ?</a>
                                            </div>
                                        </div>
                                        <div class="kt-login__actions">
                                            <button id="" type="submit"
                                            {{-- class="btn btn-brand btn-pill kt-login__btn-primary">Connexion --}}
                                            class="btn btn-brand btn-pill kt-login__btn-primary" style="font-size: 18px">Connexion
                                            </button>
                                        </div>
                                    </form>
                                </div>
                   ...
                   Vous n'avez pas encore de compte ?
                        ...
                        &nbsp;&nbsp;
                        {{-- <a href="{{route('register')}}" class="kt-login__account-link"> CREER UN COMPTE </a> --}}
                        <a href="{{route('register')}}" class="kt-login__account-link" style="font-size: 18px; color:#3758FF"> CREER UN COMPTE </a>
                    </div>
                </div>
            </div>
