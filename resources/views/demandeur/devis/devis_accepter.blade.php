                ...
                <div class="kt-portlet__head kt-portlet__head--lg bg-blue">
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand colors-item" role="tablist">
                            <li class="nav-item ">
                                <a class="nav-link" href="{{route('demandeur.mes_devis')}}" role="tab"
                                   aria-selected="false">
                                    Nouveau
                                </a>
                            </li>
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="kt-portlet__body">
                        <div class="tab-content">
                            ...
                            <table id="kt_table_1" role="grid" style="width: 1237px;" class="table table-striped dataTable no-footer dtr-inline collapsed" class="table table-striped" id="kt_table_1">
                                <thead>
                                    <tr>
                                    <th>Categerie</th>
                                        <th>Nom Artisan</th>
