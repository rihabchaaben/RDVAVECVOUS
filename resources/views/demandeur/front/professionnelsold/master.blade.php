...
@include('layouts.front.professionnels.header')
...
<!-- begin:: Footer -->
@include('layouts.front.professionnels.footer')
<!-- end:: Footer -->

<!-- begin:: Aside -->
@include('layouts.front.professionnels.sidebar')
<!-- end:: Aside -->
...
<!--end::Page Scripts -->
<script src="../assets/app/custom/wizard/wizard-v4.js" type="text/javascript"></script>
