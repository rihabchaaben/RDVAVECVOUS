            ...
            <!-- end:: Content Head -->
                ...
                <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                    <div class="alert alert-outline-brand fade show" role="alert">
                        ...
                        <div class="alert-text" style="font-size: 18px">Vos coordonnées ne seront communiqués qu'aux professionnels que vous
                            aurez sélectionnés.
                        </div>
                    ...
                    <div class="kt-portlet kt-portlet--tabs">
                        ...
                        <div class="kt-portlet__body">
                            <form action="{{route('demandeur.profile_save',Auth::user()->demandeur->id)}}"
                                                ...
                                                <div class="kt-section kt-section--first">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle-"
                                                                    ...
                                                                    @if(!$demandeur->avatar) @endif>
                                                                        <img src="{{asset('storage/'.$demandeur->avatar)}}"
                                                                             id="blah" alt=""
                                                    ...
                                                    <i class="fa fa-times"></i>
                                                        ...
                                                        @if(!$demandeur->nom)
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        {{-- <label>Vous êtes une agence ou particulier --}}
                                                                        <label>Vous êtes une agence ou un particulier
                                                                            ?</label>
                                                                        <div class="kt-radio-inline">
                                                                            <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                                <input type="radio"
                                                                                       id="particulier_check"
                                                                                       name="agence" value="0" checked>
                                                                                Particulier
                                                                                <span></span>
                                                                            </label>
                                                                            <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                                <input type="radio" id="agence_check"
                                                                                       name="agence" value="1">
                                                                                Agence
                                                                                <span></span>
                                                                            </label>
                                                        ...
                                                        <div class="form-group row" id="name"
                                                             @if($demandeur->agence)style="display:none"@endif>
                                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                                Nom</label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control" name="nom"
                                                                       value="{{$demandeur->user->name}}">
                                                            </div>
                                                            @if ($errors->has('nom'))
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-6">
                                                                    <input class="form-control" name="nom_societe"
                                                                           @if($demandeur->agence) value="{{$demandeur->agence->nom_societe}}" @endif>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-xl-3 col-lg-3 col-form-label">
                                                                ...
                                                                <div class="col-lg-9 col-xl-6">
                                                                    <input class="form-control" name="nom_contact"
                                                                           @if($demandeur->agence) value="{{$demandeur->agence->nom_contact}}" @endif>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                        ...
                                        <strong style="color: red;">{{ $errors->first('email') }}</strong>
                                                        ...
                                                        <div class="form-group form-group-last row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                ...
                                                                {{-- <span class="form-text text-muted">Code daffeliation cest le code refale pour inviter.</span> --}}
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class=" col-lg-6">
                                                                <select class="form-control" id="js-data-example-ajax"
                                                                        name="ville_id">
                                                                    @if($demandeur->ville_id)
                                                                        <option value="{{$demandeur->ville->id}}">{{$demandeur->ville->name}}</option>
                                                                    @endif
                                                                </select>
                                                            </div>
