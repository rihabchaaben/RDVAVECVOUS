                ...
                <div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
                    ...
                    <div class="kt-portlet kt-portlet--tabs">
                        ...
                        <div class="kt-portlet__body">
                            <form action="{{route('demandeur.profile_update',Auth::user()->demandeur->id)}}"
                                                    ...
                                                    <i class="fa fa-times"></i>
                                                        ...
                                                        @else
                                                            <div class="section-hide">
                                                                ...
                                                                <span class="" role="alert">
                                                                    <strong style="color: red;">{{ $errors->first('nom_societe') }}</strong>
                                                                </span>
                                                                @endif
                                                                    </div>
                                                                ...
                                                                <span class="" role="alert">
                                                                    <strong style="color: red;">{{ $errors->first('nom_contact') }}</strong>
                                                                </span>
                                                                @endif
                                                                    </div>
