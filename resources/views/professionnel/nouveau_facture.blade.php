                            ...
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                                ...
                                <form class="kt-form" id="kt_form" novalidate="novalidate">
                                    ...
                                    <div class="kt-wizard-v1__content" data-ktwizard-type="step-content"
                                         data-ktwizard-state="current">
                                        <div class="kt-heading kt-heading--md">Indiquer votre code promo pour vous</div>
                                        <div class="kt-form__section kt-form__section--first">
                                            <div class="kt-wizard-v1__form">
                                                <div class="form-group">
                                                    <label>Si vous navez pas un code promo vous le laisser vide</label>
                                                    <input type="text" class="form-control" name="address1"
                                                           placeholder="Saissiez votre code promo" value="">
                                                    <span class="form-text text-muted">votre code.</span>
                                                </div>
