        ...
        <div class="kt-content kt-grid__item kt-grid__item--fluid">
            <div class="alert alert-info fade show" role="alert">
                ...
                <div class="alert-text" style="font-size: 16px">
                                    ...
                                    <p>L'acceptation du devis donne uniquement l' information à l 'artisan de votre volonté à le voir
                        pratiquer ces prestations.</p>
                    <p class="mb-0">Pour être exécuté et juridiquement valable, le devis doit être imprimé, signé
                        précedé de la mention "BON POUR ACCORD"</p>
                </div>
                                ...
                                <div class="kt-invoice__brand">
                                    ...
                                    <div href="#" class="kt-invoice__logo">
                                        <a href="#" style="color:white">
                                            <h1>{{$devi->proposition->professionnel->nom_societe ?? $devi->proposition->professionnel->nom}}</h1>
                                        </a>
