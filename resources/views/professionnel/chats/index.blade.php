                        ...
                        <div class="kt-portlet kt-portlet--last">
                            <div class="kt-portlet__body">
                                ...
                                <span class="kt-media kt-media--circle">
                                    @if($user->userFrom->demandeur->avatar)
                                        <img src="{{asset('storage/'.$user->userFrom->demandeur->avatar)}}"
                                             alt="image">
                                    @else
                                        <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bolder">{{ucfirst($user->userFrom->demandeur->nom[0])}}</span>
                                    @endif
                                </span>
                                                    <div class="kt-widget__info">
                                                        <div class="kt-widget__section">
                                                            <a href="{{route('pro.chat.show',[$user->proposition_id,'#last_chat'])}}"
                                                               class="kt-widget__username">{{$user->userFrom->demandeur->nom}}</a>
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid kt-app__content" id="kt_chat_content">
                        <div class="kt-chat">
                            <div class="kt-portlet kt-portlet--head-lg kt-portlet--last">
                                            ...
                                            <div class="kt-chat__label">
                                                <a href="#"
                                                   class="kt-chat__title">
                                                    {{$messages->first()->userTo->name}}
                                                </a>
                                                <span class="kt-chat__status">
                                    {{$messages->first()->proposition->demande->events->first()->titre}}
                                </span>
                                            </div>
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    <span class="kt-media kt-media--circle kt-media--sm">
                                        ...
                                        @endif
                                                            ...
                                                            <a href="#"
                                                               class="kt-chat__username">{{$msg->userFrom->demandeur->nom}}</a>
                                       ...
                                       @if($msg->userFrom->professionnel->avatar)
                                                                    <img src="{{asset('storage/'.$msg->userFrom->professionnel->avatar)}}"
                                                                         alt="image">
                                                                @else
                                                                    <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bolder">Moi</span>
                                                                @endif
                                    </span>
                                                        </div>
                                ...
                                <form action="{{route('pro.chat.store','#last_chat')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="proposition_id"
                                           value="{{$messages->first()->proposition_id}}"> <input type="hidden"
                                                                                                  name="from_id"
                                                                                                  value="{{$messages->first()->userTo->id}}">
