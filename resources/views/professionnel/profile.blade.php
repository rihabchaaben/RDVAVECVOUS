                        ...
                        <div class="kt-portlet__head bg-blue">
                            <div class="kt-portlet__head-toolbar">
                                <ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand"
                                    role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link @if(!request()->has('tarif')) active @endif"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#kt_apps_user_edit_tab_2"
                                           role="tab"  >
                                            ...
                                            @if($errors->has('adresse') || $errors->has('cp') || $errors->has('ville_id') || $errors->has('zone_de_travail') || $errors->has('category'))
                                    ...
                                    <!-- <li class="nav-item">
                                        <a class="nav-link @if(request()->has('tarif')) active @endif" data-toggle="tab"
                        ...
                        <div class="kt-portlet__body">
                            <form action="{{route('pro.profile_update',Auth::user()->professionnel->id)}}"
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane @if(!request()->has('tarif')) active @endif"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control" name="nom_societe"
                                                                       value="{{isset($professionnel->nom_societe) ? $professionnel->nom_societe : old('nom_societe')}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <textarea class="form-control" name="description"
                                                                          rows="5">{{isset($professionnel->description) ? $professionnel->description : old('description')}}</textarea>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control" name="siret"
                                                                       value="{{isset($professionnel->siret) ? $professionnel->siret : old('siret')}}">
                                                                @if ($errors->has('siret'))
                                                                    <span class="" role="alert">
                                        <strong style="color: red;">{{ $errors->first('siret') }}</strong>
                                           </span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control" name="tva"
                                                                       value="{{isset($professionnel->tva) ? $professionnel->tva : old('tva')}}">
                                                                @if ($errors->has('tva'))
                                                                    <span class="" role="alert">
                                        <strong style="color: red;">{{ $errors->first('tva') }}</strong>
                                           </span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           name="telephone"
                                                                           value="{{isset($professionnel->telephone) ? $professionnel->telephone : old('telephone')}}"
                                                                           placeholder="Phone"
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="mobile"
                                                                           value="{{isset($professionnel->mobile) ? $professionnel->mobile : old('mobile')}}"
                                                                           placeholder="Phone"
                                                                           aria-describedby="basic-addon1">
                                                        ...
                                                        <div class="form-group form-group-last row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control"
                                                                           name="site"
                                                                           value="{{isset($professionnel->site) ? $professionnel->site : old('site')}}">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control" type="text" name="adresse"
                                                                       value="{{isset($professionnel->adresse) ? $professionnel->adresse : old('adresse')}}"
                                                                       autocomplete="off">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control" type="text" name="cp"
                                                                       value="{{isset($professionnel->cp) ? $professionnel->cp : old('cp')}}"
                                                                       autocomplete="off">
                                                                @if ($errors->has('cp'))
                                                                    <span class="" role="alert">
                                        <strong style="color: red;">{{ $errors->first('cp') }}</strong>
                                           </span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <select class="form-control" name="category[]"    id="js-data-example-ajax_multiple_cat"
                                                                      ...
                                                                      @foreach($professionnel->categories as $cat)
                                                                            ...
                                                                            <option style="font-size: 12rem; font-weight: bold;" value="{{$cat->id}}"  selected >{{$cat->label}}</option>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control" type="text"
                                                                       name="nom_assurance"
                                                                       value="{{isset($professionnel->nom_assurance) ? $professionnel->nom_assurance : old('nom_assurance')}}"
                                                                       autocomplete="off">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control" type="text"
                                                                       ...
                                                                       value="{{isset($professionnel->description_garantie) ? $professionnel->description_garantie : old('description_garantie')}}"
                                                                       autocomplete="off">
