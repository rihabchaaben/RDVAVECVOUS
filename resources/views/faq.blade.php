                    ...
                    <div class="col-xl-3">
                        <ul class="kt-nav" id="kt_nav" role="tablist">
                            <li class="kt-nav__item  kt-nav__item--active">
                                <a class="kt-nav__link" role="tab" id="kt_nav_link_1" data-toggle="collapse"
                                   href="#kt_nav_sub_1" aria-expanded="false">
                                    <span class="kt-nav__link-text" style="font-size: 14px">JE SUIS UN PROFESSIONNEL</span>
                                    ...
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            ...
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseSeven1" style="font-size: 14px">Comment s’inscrire et recevoir des demandes</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseEigth1" style="font-size: 14px">Comment se passe la prise de rendez-vous?</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseNine1" style="font-size: 14px">Comment s’organise les paiements</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseTen1" style="font-size: 14px">Puis-je communiquer avec le demandeur avant le RDV?</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseEleven1" style="font-size: 14px">Comment puis-je être choisi par le demandeur</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseTwelve1" style="font-size: 14px">Comment envoyer un devis</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseThirteen1" style="font-size: 14px">Quels sont les tarifs dans ma catégorie?</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" style="font-size: 14px">Je ne trouve pas ma facture</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="kt-nav__item  kt-nav__item--active">
                                <a class="kt-nav__link" role="tab" id="kt_nav_link_1" data-toggle="collapse"
                                   href="#kt_nav_sub_1" aria-expanded="false">
                                    <span class="kt-nav__link-text" style="font-size: 14px">JE SUIS DEMANDEUR</span>
                                    <span class="kt-nav__link-arrow"></span>
                                </a>
                                <ul class="kt-nav__sub show" id="kt_nav_sub_1" role="tabpanel"
                                    aria-labelledby="m_nav_link_1" data-parent="#kt_nav" style="">
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseOne1" style="font-size: 14px">Faire une demande</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseTwo1" style="font-size: 14px">Consulter mes rendez-vous prévus</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseThree1" style="font-size: 14px">La protection de mes coordonnées</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseFour1" style="font-size: 14px">Puis - je avoir un devis sans RDV?</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseFive1" style="font-size: 14px">Comment consulter les devis</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-bullet kt-nav__link-bullet--line"><span></span></span>
                                            <span class="kt-nav__link-text" data-toggle="collapse"
                                                  data-target="#collapseSix1" style="font-size: 14px">Un professionnel que je connais déjà</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingSeven1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseSeven1" style="font-size: 14px">
                                ...
                                <div id="collapseSeven1" class="collapse" aria-labelledby="headingSeven1"
                                    ...
                                    <div class="card-body">
                                        <p style="font-size: 14px">
                                            Il vous suffit de suivre pas à pas les étapes du formulaire d'inscription(
                                            lien url) et sélectionner les deux paramètres qui vous permettrons de
                                            recevoir vos premières demandes :
                                            - La catégorie d'activité qui vous concerne
                                            - La zone géographique pour laquelle vous acceptez de recevoir des demandes
                                            de RDV.
                                            Ainsi vous recevrez les demandes concernant votre domaine d'activité et
                                            n'allant pas au delàs de la zone indiqué. A tous moment, sur le MENU, dans
                                            l'onglet MON PROFIL, vous pourrez modifier votre sélection.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEight1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseEight1" style="font-size: 14px">
                                ...
                                <div id="collapseEight1" class="collapse" aria-labelledby="headingEight1"
                                    ...
                                    <div class="card-body">
                                        <p style="font-size: 14px">
                                            Lorsqu’une demande se trouve être dans votre domaine d’activité et dans
                                            votre zone géographique, vous la retrouvez sur un tableau qui vous indique
                                            les détails de la demande, la date et le créneau horaire souhaité par le
                                            demandeur. Si vous souhaitez proposer votre candidature, vous devez cliquer
                                            sur l'icône qui indique au demandeur votre offre de rendez-vous et lui donne
                            ...
                            <div class="card">
                                <div class="card-header" id="headingNine1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseNine1" style="font-size: 14px">
                                ...
                                <div id="collapseNine1" class="collapse" aria-labelledby="headingNine1"
                                    ...
                                    <div class="card-body">
                                        <p style="font-size: 14px">
                                            Pour plus de sécurité, vous renseignez lors de votre premier RDV vos
                                            coordonnées bancaire se trouvant sur votre RIB.
                                            Nous procéderons ainsi à des prélèvements déclenchés UNIQUEMENT à
                                            l'acceptation du rendez-vous par le demandeur suite à une proposition de
                                            votre part.
                                            En effet, si les demandes ne vous intéresse pas, ou que vous n'êtes pas
                                            disponible, vous ne proposerez pas de rendez-vous et ne serez pas facturé.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTen1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseTen1" style="font-size: 14px">
                                ...
                                <div id="collapseTen1" class="collapse" aria-labelledby="headingTen1"
                                    ...
                                    <div class="card-body">
                                        <p style="font-size: 14px">
                                            Sur votre profil, un descriptif de votre entreprise permet au demandeur de
                                            mieux connaître vos compétences et ainsi mieux faire leur choix. Le choix de
                                            l'image qui vous représente est aussi essentiel, ce peut être votre logo, la
                                            photo d'une réalisation ou pourquoi pas la photo de votre équipe. Lors de
                                            votre proposition de RDV vous aurez aussi la possibilité de laisser un
                                            message, une dernière manière d'être convaincant.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEleven1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseEleven1" style="font-size: 14px">
                                ...
                                <div id="collapseEleven1" class="collapse" aria-labelledby="headingEleven1"
                                    ...
                                    <div class="card-body">
                                        <p style="font-size: 14px">
                                            Après tout RDV, le demandeur attends votre devis. Celui-ci doit être adressé
                                            au plus vite pour permettre au demandeur de programmer votre intervention.
                                            Dans le MENU à l'onglet MES DEVIS, vous retrouverez la liste des demandeurs
                                            en attente et un formulaire à remplir de vos cotations et tarifs.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwelve1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseTwelve1" style="font-size: 14px">
                                ...
                                <div id="collapseTwelve1" class="collapse" aria-labelledby="headingTwelve1"
                                    ...
                                    <div class="card-body">
                                        <p style="font-size: 14px">
                                            ...
                                            Le prélèvement aura lieu UNIQUEMENT pour les RDV acceptés non annulés par le
                                            demandeur.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThirteen1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseThirteen1" style="font-size: 14px">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <div class="card-title" data-toggle="collapse" data-target="#collapseOne1"
                                         aria-expanded="false" aria-controls="collapseOne1" style="font-size: 14px">
                                        Faire une demande.
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo1"
                                         aria-expanded="false" aria-controls="collapseTwo1" style="font-size: 14px">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseThree1" style="font-size: 14px">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingfour1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapsefour1" style="font-size: 14px">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingfive1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseFive1" style="font-size: 14px">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingSix1">
                                    <div class="card-title collapsed" data-toggle="collapse"
                                         ...
                                         aria-controls="collapseSix1" style="font-size: 14px">
...
@endsection
{{-- 02/10/2020 : added  style="font-size: 14px" tag --}}
