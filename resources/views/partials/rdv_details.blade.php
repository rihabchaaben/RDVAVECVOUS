<div class="modal fade" id="kt_modal_rdv_details{{$key}}" tabindex="-1" role="dialog"
                                ...
                                <h3 class="kt-portlet__head-title">
                                    @foreach($proposition->demande->events as $event)
                                        ...
                                        <span style="font-size:15px">{{ $event->start_date->formatLocalized('%d %B %Y')}}
                                            ...
                                            À {{$event->end_date->format('H:i')}} </span>
                                    @endforeach
                                </h3>
                            </div>
                        </div>
                            ...
                            <div class="accordion  accordion-toggle-arrow" id="accordionExample4">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseSix4" class="collapse" aria-labelledby="headingThree1"
                                         data-parent="#accordionExample4">
                                        <div class="card-body">
                                        {{$proposition->demande->demandeur->nom}}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseFour4" class="collapse" aria-labelledby="headingThree1"
                                        ...
                                        <div class="card-body">
                                            ...
                                            {{isset($proposition->demande->ville) ? $proposition->demande->ville->name : ''}}
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
