                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                            ...
                            <!--begin: Form Wizard Step 1-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="kt-radio-inline">
                                                    ...
                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                        ...
                                                        Ma liste @if($vips->isEmpty()) '
                                                        votre liste est vide ' @endif
                                                        <span></span>
                                                    </label>
                                                    {{--@endif--}}
                                                </div>
                                                           ...
                                                           @if(!$historiques->isEmpty())
                                                            <optgroup label="Historique">
                                                                @foreach($historiques as $historique)
                                                                    <option value="{{$historique->professionnel->id}}">{{$historique->professionnel->nom}}</option>
                                                                @endforeach
                                                            </optgroup>
                                                            @endif
                                ...
                                <div class="kt-wizard-v1__content row" data-ktwizard-type="step-content"
                                    ...
                                    <div class="kt-heading kt-heading--md col-md-8 mx-auto" style="padding-left: 100px;">PRECISEZ L'ADRESSE</div>
